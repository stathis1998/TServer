...
#define COUNTRY_BAL_TICK					60*60*1000
#endif
...
#define COLLECTION_KIND                     111
#define ANGEL_KIND                          113
#define FORTUNE_KIND                        114

#define ANGEL_DELAYG_ID                     18086
#define EVOCATE_NORMAL						1
#define EVOCATE_MAX							3
...
#define CASH_BOLT							(25020)
#define CASH_ARROW							(25021)
#define CASH_AXE							(25022)
#define THROWING_AXE_ITEMID					(8412)
#define BOW_DEFAULT_SPAWNID                 (WORD) 20000

#define BATTLERANK_FIRST                    1750
...
#define EFFECTCHANGE_ID						24501

#define MAX_SECURITY_TRIES					10
...
typedef enum PROB_TYPE
{
	...
	PROB_UPGRADE,
	PROB_ITEMGUARD,  
	PROB_ITEMGUARD_MEDIUM,
	PROB_ITEMGUARD_GREATER,
	PROB_RAREMAGIC
};
...
typedef enum PORTALCONDITION_TYPE
{
	...
	PCT_TOURNAMENTGUEST,
	PCT_MEETING,
	PCT_SKYGARDEN_ATTACKPOS,
	PCT_SKYGARDEN_DEFENDPOS,
	PCT_SKYGARDEN_LEFT,
	PCT_SKYGARDEN_MIDDLE,
	PCT_SKYGARDEN_RIGHT,
	PCT_SKYGARDEN_ATTACKPOS_LEFT,
	PCT_SKYGARDEN_DEFENDPOS_LEFT,
	PCT_SKYGARDEN_ATTACKPOS_CENTER,
	PCT_SKYGARDEN_DEFENDPOS_CENTER,
	PCT_SKYGARDEN_ATTACKPOS_RIGHT,
	PCT_SKYGARDEN_DEFENDPOS_RIGHT
};
...
typedef enum PREMIUMSKILL_TYPE
{
	PREMIUMSKILL_BOW = 0,
	PREMIUMSKILL_NORMAL,
	PREMIUMSKILL_COUNT
...
typedef struct tagTTNMTINVEN				TTNMTINVEN, *LPTTNMTINVEN;
typedef struct tagTTNMTITEM					TTNMTITEM, *LPTTNMTITEM;
...
typedef struct tagGEMGRADE					TGEMGRADE, *LPTGEMGRADE;
...
typedef struct tagSADDLE                    TSADDLE,*LPTSADDLE;
typedef struct tagDUEL						TDUEL, *LPTDUEL;
typedef struct tagCOMP                      TCOMP, *LPTCOMP;
typedef struct tagCOMPBONUS                 TCOMPBONUS, *LPTCOMPBONUS;

typedef struct tagSECURE					TSECURE, *LPTSECURE;
...
typedef struct tagTTITLETEMP				TTITLETEMP, *LPTTITLETEMP;
typedef struct tagTTITLE					TTITLE, *LPTTITLE;

typedef struct tagBOWITEM					BOWITEM, *LPBOWITEM;
typedef struct tagBOWBONUSITEM              BOWBONUSITEM, *LPBOWBONUSITEM;
typedef struct tagBOWPLAYER                 BOWPLAYER, *LPBOWPLAYER;

typedef struct tagBOWRANK                   BOWRANKING, *LPBOWRANKING;
typedef struct tagBOWGRANK					BOWGRANKING, *LPBOWGRANKING;
typedef struct tagPREMIUMSKILL				PREMIUMSKILL, *LPPREMIUMSKILL;
typedef struct tagUSEDSKILL                 USEDSKILL, *LPUSEDSKILL;

typedef struct tagBRTEAM                    BRTEAM, *LPBRTEAM;
typedef struct tagBRPLAYER                  BRPLAYER, *LPBRPLAYER;
typedef struct tagBRSPAWNPOS                BRSPAWNPOS, *LPBRSPAWNPOS;
typedef struct tagRAWPOS                    BRRAWPOS, *LPBRRAWPOS;
typedef struct tagBRPREMADEPLAYER           BRPREMADEPLAYER, *LPBRPREMADEPLAYER;
typedef struct tagBRSUPPLIES                BRSUPPLIES, *LPBRSUPPLIES;

typedef struct tagBATTLERANK                BATTLERANK, *LPBATTLERANK;
typedef struct tagSPECIALBOX                SPECIALBOX, *LPSPECIALBOX;




typedef struct tagCUSTOMCLOAK					TCUSTOMCLOAK, *LPTCUSTOMCLOAK;
typedef struct tagGUILDSKILL				GUILDSKILL;
typedef struct tagACCESSORYMAGIC			ACCESSORYMAGIC;
typedef struct tagGUILDCOOLDOWN				GUILDCOOLDOWN;
/////////////////////////////////////////////////////////////////////////////////////////////////
// TMapSvr class type
...
typedef vector< LPTTNMTITEM >				VTTNMTITEM, *LPVTTNMTITEM;
typedef vector<LPBOWITEM>			    	VBOWITEM, *LPVBOWITEM;
typedef vector<LPBOWRANKING>                VBOWRANKING, *LPVBOWRANKING;
typedef vector<LPPREMIUMSKILL>              VPREMIUMSKILL, *LPBOWPREMIUMSKILL;
typedef vector<LPUSEDSKILL>                 VUSEDSKILL, *LPVUSEDSKILL;
typedef vector<BRRAWPOS>                    VBRRAWPOS, *LPVRAWPOS;
typedef vector<LPBRSUPPLIES>                VBRSUPPLIES;
typedef vector<LPBATTLERANK>                VBATTLERANK, *LPVBATTLERANK;
typedef vector<LPSPECIALBOX>				VSBITEM, *LPVSBITEM;



typedef vector<ACCESSORYMAGIC>				VACCESSORYMAGIC;
/////////////////////////////////////////////////////////////////////////////////////////////////
// TMapSvr map type
...
typedef map< BYTE, LPTTNMTINVEN>			MAPTTNMTINVEN, *LPMAPTTNMTINVEN;
...
typedef map< DWORD, LPTSADDLE>              MAPTSADDLE, *LPMAPTSADDLE;

typedef map< DWORD, LPTDUEL>				MAPTDUEL, *LPMAPTDUEL;
//typedef map< DWORD, LPTSECURE>				MAPTSECURE, *LMAPTSECURE; //SC
...
typedef map< WORD, LPTTITLETEMP>			MAPTTITLETEMP, *LPMAPTTITLETEMP;
typedef map< WORD, LPTTITLE>				MAPTTITLE, *LPMAPTTITLE;


typedef map< DWORD, CTPlayer*>              MAPSAVEDPLAYER, *LPMAPSAVEDPLAYER;
typedef map< WORD, LPBOWBONUSITEM>          MAPBOWBONUSITEM, *LPMAPBONUSITEM; 
typedef map< DWORD, LPBOWPLAYER>            MAPBOWPLAYER, *LPMAPBOWPLAYER;
typedef map< DWORD, LPBOWGRANKING>          MAPBOWGRANKING, *LPMAPBOWGRANKING;

typedef map< DWORD, LPBRTEAM>               MAPBRTEAM, *LPMAPBRTEAM;
typedef map< DWORD, LPBRPLAYER>             MAPBRPLAYER, *LPMAPBRPLAYER;
typedef map< WORD, LPBRSPAWNPOS>            MAPBRSPAWNPOS, *LPMAPBRSPAWNPOS;
typedef map< WORD, VSBITEM>					MAPSPECIALBOX;
typedef map<WORD, LPTCUSTOMCLOAK>			MAPTCUSTOMCLOAK, * LPMAPTCUSTOMCLOAK;
typedef map<DWORD, GUILDCOOLDOWN>		MAPGUILDCOOLDOWN;

/////////////////////////////////////////////////////////////////////////////////////////////////
// TMapSvr structure define

struct tagGUILDCOOLDOWN
{
	std::vector<std::pair<WORD, DWORD>> m_vSkill;
};

struct tagACCESSORYMAGIC
{
	BYTE m_ID;
	BYTE m_MagicID;
	WORD m_MinValue;
...
struct tagBATTLERANK
{
	BYTE m_bRank;
	DWORD m_dwPoints;
};

struct tagBRSUPPLIES
{
	WORD m_wItemID;
	DWORD m_dwTick;
};

struct tagBRPREMADEPLAYER
{
	CString m_strName;
	BYTE m_bReady;
};
...
struct tagCOMP
{
	...
	__time64_t m_dEndTime[PETITEMS_COUNT];
	DWORD m_dwTick;
	/* BONUSES */
	BYTE m_bBonusID;
};
...
struct tagARENA
{
	...
	BYTE m_MaxWinCount;
	std::vector<ArenaPlayer> m_TopPlayer;
};
...
#include "TSelfObj.h"
#include "TCompanionClass.h"
#include "TMiniDump.h"
#include "TTextLinker.h"
#include "TTextLinkData.h"

#include "TBowSettings.h"
